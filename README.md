...
# Architecture overview
 ...
 ## LLM Call:   
 Used pyPDF2 to convert user uploaded pdf to text and passed it as a parameter to 'generate_content_stream' function for gemini client which works as per requirement and returns 
